...
public class DoubleAngularSpectrumGPU extends DoublePropagatorGPU {
     ...
     * @throws IOException
     */
    public DoubleAngularSpectrumGPU(int M, int N, double lambda, double z, double dx, double dy) throws IOException {
    ...
    private void declareKernels() throws IOException {
        ...
        cuModuleGetFunction(multiplication, module, "multiplicationASD");
    }
